...
This project relies upon seven datasets that should be downloaded from the accompanying [figshare](https://doi.org/10.6084/m9.figshare.28114247.v2) repository and added to the ``data`` folder. It should therefore look like the following:
```
data
├── declarations.csv
├── users.csv
